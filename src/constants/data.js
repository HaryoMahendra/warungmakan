...
export const pelengkap = [
  ...
  { nama: "Teh Anget", harga: "Rp 3.000", img: "/assets/menu/tehanget.jpg", deskripsiLengkap: "Terdapat pilihan teh anget dan teh manis yang menyegarkan.", kategori: "Minuman", rating: "4.9" },
  { nama: "Es Teh", harga: "Rp 4.000", img: "/assets/menu/esteh.jpg", deskripsiLengkap: "Terdapat pilihan es teh manis dan es teh tawar yang menyegarkan.", kategori: "Minuman", rating: "4.8" },
  { nama: "Jeruk Anget Peras", harga: "Rp 4.000", img: "/assets/menu/jerukperasanget.jpg", deskripsiLengkap: "Terdapat pilihan jeruk anget manis dan jeruk anget tawar yang menyegarkan.", kategori: "Minuman", rating: "4.9" },
  { nama: "Es Jeruk Peras", harga: "Rp 5.000", img: "/assets/menu/esjerukperas.jpg", deskripsiLengkap: "Terdapat pilihan es jeruk manis dan es jeruk tawar yang menyegarkan.", kategori: "Minuman", rating: "4.9" },
];
...
export const filterMap = {
  ...
  Lauk: ["Perkedel", "Telur Asin", "Tahu dan Tempe Goreng", "Kerupuk", "Keripik Usus", "Kacang Goreng"],
  Minuman: ["Teh Anget", "Es Teh", "Jeruk Anget Peras", "Es Jeruk Peras"],
};
