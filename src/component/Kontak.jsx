...
export default function Kontak({ kontakRef, isDark, t }) {
  const mapsLink = "https://www.google.com/maps/place/RM.+Soto+Ayam+Kampung+Khas+Pacitan/@-7.6303044,111.5397765,769m/data=!3m1!1e3!4m6!3m5!1s0x2e79bf0039212bad:0xb5d6eb252b3cf246!8m2!3d-7.6303044!4d111.5397765!16s%2Fg%2F11c5q9v_7k";

  const rows = [
    {
      iconPath: <><path d="M12 21s-8-6.5-8-12a8 8 0 1116 0c0 5.5-8 12-8 12z"/><circle cx="12" cy="9" r="2.5"/></>,
      label: "Alamat",
      value: "Perum Bumi Antariksa, Jl. Hercules Blok J No.6, Klegen, Kartoharjo, Kota Madiun, Jawa Timur",
      href: mapsLink,
    },
    {
      isWA: true,
    ...
    },
    {
      ...
      value: "Setiap Hari · 06.00 WIB - Habis",
    },
  ];
      ...
      <div style={{ maxWidth: 1040, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 className="serif" style={{ fontSize: "clamp(28px,3.5vw,46px)", fontWeight: 900, lineHeight: 1.06, color: t.text, marginBottom: 18 }}>
            Ingin <em style={{ color: t.accent, fontStyle: "italic" }}>Pesan</em>?
          </h2>
        ...
        <div className="kontak-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, alignItems: "stretch" }}>
          <div style={{ borderRadius: 18, overflow: "hidden", border: `1px solid ${t.borderStrong}`, minHeight: 320 }}>
            <iframe
              ...
              allowFullScreen loading="lazy" title="Lokasi Soto Ayam Kampung Pacitan"
            />
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {rows.map(row => {
              const cardStyle = {
                ...
                padding: "18px", textDecoration: "none", cursor: row.href ? "pointer" : "default",
              ...
              const content = (
                <>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 13, color: row.isWA ? t.textMuted : t.textMuted, lineHeight: 1.65 }}>{row.value}</div>
                  </div>
                </>
              );
